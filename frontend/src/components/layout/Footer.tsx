    ...
    <footer className="bg-slate-900 dark:bg-slate-950 text-white border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              {['facebook', 'instagram', 'twitter'].map((s) => (
                <a key={s} href="#" className="w-9 h-9 rounded-xl bg-slate-800 dark:bg-slate-900 flex items-center justify-center hover:bg-brand-500 transition-colors text-slate-400 hover:text-white">
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500 dark:text-slate-400">&copy; 2026 MoldovaGuide. Toate drepturile rezervate.</p>
          <p className="text-xs text-slate-500 dark:text-slate-400">Realizat cu dragoste pentru Moldova</p>
        </div>
      </div>
    </footer>
  );
