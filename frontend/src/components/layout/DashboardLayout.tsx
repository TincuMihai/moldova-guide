    ...
    <div className="min-h-screen bg-stone-50 dark:bg-slate-950">
      ...
      <div className={`pt-16 transition-all duration-300 ${isOpen ? 'lg:pl-64' : 'lg:pl-[72px]'}`}>
        ...
        <div className="lg:hidden px-4 pt-4">
          <button onClick={toggleMobile} className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
